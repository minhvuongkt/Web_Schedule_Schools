...
/** Same paper/notebook identity as the login page. */
const NOTEBOOK_GRID = {
  backgroundImage:
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-2xl ring-1 ring-stone-900/5">
          <div className="mb-6 text-center">
            ...
            <h1 className="mt-1 text-2xl font-semibold text-stone-900">Quên mật khẩu</h1>
        ...
        <p className="mt-4 text-center text-xs text-stone-500">
          Chưa có email trong hồ sơ? Liên hệ văn phòng trường để được cấp lại.
        </p>
      </div>
    </div>
  );
