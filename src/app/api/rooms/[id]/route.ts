...
import { updateRoom, deleteRoom } from "@/server/services/catalog.service";
...
/** DELETE /api/rooms/:id — only when no timetable entry uses it (409 otherwise). */
